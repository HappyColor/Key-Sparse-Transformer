...
def build_ks_transformer(self_attn, num_layers, embed_dim, qdim=None, kdim=None, ffn_embed_dim=2304, num_heads=8, dropout=0.1, attention_dropout=0.1, activation='relu'):
    '''
    ...
    if self_attn:
        if kdim is not None:
            print("you don't need to provide kdim in build_ks_transformer when doing self attention")
    else:
